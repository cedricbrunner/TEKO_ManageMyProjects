...
namespace ManageMyProjects.Controllers
{
    public class PhasesActivitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create(IFormFile FileContent, [Bind("PhaseActivityName,PhaseActivityProgress,PhaseActivityStartDatePlanned,PhaseActivityEndDatePlanned,PhaseActivityStartDateRealized,PhaseActivityEndDateRealized,EmployeeId,PhaseId,StatusId,ProjectId,Id")] PhasesActivity phasesActivity)
        {
            ...
            ViewData["EmployeeId"] = new SelectList(_context.Employees, "Id", "Id", phasesActivity.EmployeeId);
            ViewData["PhaseId"] = new SelectList(_context.Phases, "Id", "Id", phasesActivity.PhaseId);
            ViewData["ProjectId"] = new SelectList(_context.Projects, "Id", "Id", phasesActivity.ProjectId);
            ViewData["StatusId"] = new SelectList(_context.Status, "Id", "Id", phasesActivity.StatusId);
            return View(phasesActivity);
        }
