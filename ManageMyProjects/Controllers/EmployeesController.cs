...
namespace ManageMyProjects.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ManageMyProjectDbContext context)
        {
            _context = context;
        }
        ...
        {
            var manageMyProjectDbContext = _context.Employees.Include(e => e.Department).Include(e => e.Function);
